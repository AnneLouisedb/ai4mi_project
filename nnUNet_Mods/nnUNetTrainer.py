...
class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict, unpack_dataset: bool = True,
                 device: torch.device = torch.device('cuda'), dropout_prob = 0.0):
        ...
        self.device = device
        print('CONFIGURATION', configuration) # this is '2d'
    ...
    def initialize(self):
        if not self.was_initialized:
            ...
            print(f"loaded network.. {self.configuration_manager.network_arch_class_name} ") # dynamic_network_architectures.architectures.unet.PlainConvUNet
    ...
    def build_network_architecture(architecture_class_name: str,
                                   ...
                                   dropout_prob: float = 0.0) -> nn.Module:
        """
        ...
        # Move up three levels (out of nnUNetTrainer, nnunetv2, and nnUNet)
        ...
        print(sys.path)
        # no moduel named UNet? 

        from UNet.unet_model import UNetDR, SUNet, UNet
        if architecture_class_name == 'UNetDR':
            print("network, UNETDR")
            return UNetDR(num_input_channels, num_output_channels)

        elif architecture_class_name == 'UNet':
            print("network, UNET")
            return UNet(num_input_channels, num_output_channels)

        elif architecture_class_name == 'SUNet':
            print(f"network, SUNET, dropout, {dropout_prob}")
            return SUNet(num_input_channels, num_output_channels, dropout_prob = dropout_prob)

        elif architecture_class_name == 'SUNetdropout':
            print("network, SUNET with DROPOUT")
            return SUNet(num_input_channels, num_output_channels, dropout_prob = dropout_prob)

        
        else:
            print("RUNNING DEFAULT ARCHITECTURE ")
