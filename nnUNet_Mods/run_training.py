...
def run_training_entry():
    ...
    parser.add_argument('--val_best', type=bool, default = True,  required=False,
                        help='If set, the validation will be performed with the checkpoint_best instead '
    ...
    parser.add_argument('--dropout_prob', type=float, default=0.0, required=False,
                    help='[OPTIONAL] Dropout probability. Default is 0.0.')
    ...
    run_training(args.dataset_name_or_id, args.configuration, args.fold, args.tr, args.p, args.pretrained_weights,
                 ...
                 device=device, dropout_prob = args.dropout_prob)
